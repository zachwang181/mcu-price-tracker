...
- **漲跌箭頭全都是灰色的「持平」**：通路目錄價本來就不會天天變，同一顆料號連續幾天同價是正常的。要看到 ▲▼ 需要價格真的動過。箭頭旁邊把滑鼠移上去，會顯示是拿哪兩筆報價在比。
- **改了版面但網頁沒變**：GitHub Pages 的網頁檔會被瀏覽器快取約 10 分鐘。等一下，或按 ⌘⇧R 強制重新整理。價格資料不受影響，那部分每次都會重抓。
